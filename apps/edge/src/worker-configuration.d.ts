/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts --config ../../wrangler.toml` (hash: 28932624e9516608ae52aa5d3bf2c845)
// Runtime types generated with workerd@1.20260317.1 2026-03-23 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "MatchCoordinator";
	}
	interface Env {
		DB: D1Database;
		EVENT_INGEST_QUEUE: Queue;
		APP_ORIGIN: "https://app.gaming-gauntlet.com";
		EXTENSION_ORIGIN: "https://extension-files.twitch.tv";
		TWITCH_API_BASE: "https://api.twitch.tv/helix";
		TWITCH_CLIENT_ID: "fc5utkuzthjxl2xo28992adi7ymivw";
		TWITCH_REDIRECT_URI: "https://api.gaming-gauntlet.com/api/auth/twitch/callback";
		TWITCH_SHARED_BOT_LOGIN: "gauntlet_b0t";
		MATCH_COORDINATOR: DurableObjectNamespace<import("./index").MatchCoordinator>;
	}
}
